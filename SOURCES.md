...
| [awesome-rsshub-routes](https://github.com/JackyST0/awesome-rsshub-routes) | Discovery candidates for communities, security, technology media, and technical newsletters | [CC0-1.0](https://github.com/JackyST0/awesome-rsshub-routes/blob/main/LICENSE) |
...
| [RSSHub](https://github.com/DIYgod/RSSHub) | Feed routes for publishers that do not expose a first-party endpoint | [AGPL-3.0](https://github.com/DIYgod/RSSHub/blob/master/LICENSE) |
